...
public abstract class LifeQuestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static LifeQuestWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(LifeQuestWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<LifeQuestDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<LifeQuestDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<LifeQuestDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<LifeQuestDbContext, Task<T>> func)
    {
        T result;
