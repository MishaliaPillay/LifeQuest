...
namespace LifeQuest.Migrations
{
    ...
    [Migration("20250513211818_MealPlanDayFix")]
    partial class MealPlanDayFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeQuest.Domain.Health.Ingredient.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LifeQuest.Domain.Health.MealPlan.MealPlanDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LifeQuest.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LifeQuest.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LifeQuest.Domain.Fitness.Activity.Activity", b =>
                {
                    b.HasOne("LifeQuest.Domain.Fitness.ExercisePlan.ExercisePlan", "ExercisePlan")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("LifeQuest.Domain.Fitness.ExercisePlan.ExercisePlan", b =>
                {
                    b.HasOne("LifeQuest.Domain.Paths.FitnessPath.FitnessPath", "FitnessPath")
            ...
            modelBuilder.Entity("LifeQuest.Domain.Health.MealPlan.MealPlanDay", b =>
                {
                    b.HasOne("LifeQuest.Domain.Health.MealPlan.MealPlan", null)
            ...
            modelBuilder.Entity("LifeQuest.Domain.Health.MealPlan.MealPlanDayMeal", b =>
                {
                    ...
                    b.HasOne("LifeQuest.Domain.Health.MealPlan.MealPlanDay", "MealPlanDay")
                        .WithMany("MealPlanDayMeals")
            ...
            modelBuilder.Entity("LifeQuest.Domain.Person.Person", b =>
                {
                    b.HasOne("LifeQuest.Domain.Paths.Path", "SelectedPath")
                        .WithMany()
