    ...
    <div className="landing-page" style={styles.landingPage}>
      <header style={styles.header}>
        <div className="logo" style={styles.logo}>
          ...
          <Title level={3} style={styles.logoTitle}>
            Life Quest
          </Title>
        </div>
      ...
      <section style={styles.heroSection}>
        ...
        <Row gutter={48} style={styles.heroContent}>
          <Col xs={24} md={12}>
            <Title style={styles.heroTitle}>Level Up Your Life</Title>
            <Title level={3} style={styles.heroSubtitle}>
              Transform your daily habits into epic quests and watch yourself
              evolve in real-time
            </Title>
            <Paragraph style={styles.heroParagraph}>
              Our gamified self-improvement app helps you build better habits,
              track progress, and achieve your goals across fitness, nutrition,
        ...
        <Row gutter={[48, 48]} style={{ marginTop: "64px" }}>
          <Col xs={24} md={8}>
            <div style={styles.featureCard}>
              ...
              <Paragraph style={styles.featureParagraph}>
                Track your workouts, step count, and physical activities with
                gamified challenges that make fitness fun and rewarding.
              </Paragraph>
              <div>
                <div
          ...
          <Col xs={24} sm={12} md={8}>
            <div style={styles.featureCard}>
              ...
              <Paragraph style={styles.featureParagraph}>
                Get personalized meal plans and nutrition tracking to fuel your
                body properly while completing food-related quests.
              </Paragraph>
              <div>
                <div
                  onClick={() =>
          ...
          <Col xs={24} md={8}>
            <div style={styles.featureCard}>
              ...
              <Paragraph style={styles.featureParagraph}>
                Turn your tasks into quests with our productivity system that
                helps you build habits and achieve your goals.
              </Paragraph>
              <div>
                <div
                  onClick={() =>
        ...
        <Row gutter={48} align="middle">
          <Col xs={24} md={12}>
            ...
            <Paragraph style={styles.avatarParagraph}>
              Your virtual avatar visually evolves as you complete quests and
              improve your habits. See your progress reflected in real-time with
            ...
            <Space direction="vertical" size="large" style={{ width: "100%" }}>
              ...
              <div style={styles.stepItem}>
                ...
                <div>
                  ...
                  <Paragraph style={styles.stepDescription}>
                    Gain new skills and powers as you progress through your
                    journey
                  </Paragraph>
                </div>
              </div>
          ...
          <Col xs={24} sm={12}>
            <div style={styles.featureItem}>
              ...
              <div>
                ...
                <Paragraph style={styles.featureParagraph}>
                  Track your workouts, step count, and physical activities with
                  gamified challenges. Connect with fitness trackers and
                  wellness devices to automatically log your progress.
                </Paragraph>
              </div>
            </div>
          </Col>
          <Col xs={24} sm={12}>
            <div style={styles.featureItem}>
              ...
              <div>
                ...
                <Paragraph style={styles.featureParagraph}>
                  Get personalized meal plans and nutrition tracking to fuel
                  your body properly. Complete food-related quests and maintain
                  a balanced diet with our smart recommendations.
                </Paragraph>
              </div>
            </div>
          </Col>
          <Col xs={24} sm={12}>
            <div style={styles.featureItem}>
              ...
              <div>
                ...
                <Paragraph style={styles.featureParagraph}>
                  Turn your tasks into quests with our productivity system.
                  Build habits, achieve goals, and stay motivated with rewards
                  and achievements that make work feel like play.
                </Paragraph>
              </div>
            </div>
          </Col>
          <Col xs={24} sm={12}>
            <div style={styles.featureItem}>
              ...
              <div>
                ...
                <Paragraph style={styles.featureParagraph}>
                  Track your emotional wellbeing with AI-powered journaling. Use
                  text or voice entries to log your feelings, and receive
                  insights and suggestions to improve your mental health.
                </Paragraph>
              </div>
            </div>
          </Col>
      ...
      <section style={styles.ctaSection}>
        ...
        <div style={styles.ctaContent}>
          <Title style={styles.ctaTitle}>Start Your Life Quest Today</Title>
          <Paragraph style={styles.ctaParagraph}>
            Join thousands of users who are already leveling up their lives with
            our gamified self-improvement app.
          </Paragraph>
        </div>
      </section>
        ...
        <Row gutter={[48, 32]}>
          <Col xs={24} sm={12} md={8}>
            <div style={styles.footerLogo}>
              ...
              <Title level={4} style={styles.footerLogoTitle}>
                Life Quest
              </Title>
            </div>
            <Paragraph style={styles.footerParagraph}>
              Transform your daily habits into epic quests and watch yourself
              evolve in real-time with our gamified self-improvement app.
            </Paragraph>
          </Col>
          <Col xs={12} sm={6} md={4}>
            <Title level={5} style={styles.footerLinkTitle}>
              Links
            </Title>
          ...
          <Col xs={12} sm={6} md={4}>
            ...
            <div style={styles.footerLinksContainer}>
              <Link href="/features/activity" style={styles.footerLink}>
                Activity
              </Link>
              <Link href="/features/nutrition" style={styles.footerLink}>
                Nutrition
              </Link>
              <Link href="/features/productivity" style={styles.footerLink}>
                Productivity
              </Link>
              <Link
                href="/features/mood"
